...
import { COR_PADRAO_DESTAQUE, COR_PADRAO_SECUNDARIA, HEX } from '../../../core/cores.js'
...
/**
 * Só o título é exigido para criar: rascunho pode nascer pela metade (spec §3.2). As colunas
 * NOT NULL que o formulário ainda não preencheu recebem o padrão do banco ou o do service.
 */
...
export const listEventosQuery = paginationQuery.extend({
  ...
  periodo: z.enum(['proximos', 'passados']).optional(),
})
