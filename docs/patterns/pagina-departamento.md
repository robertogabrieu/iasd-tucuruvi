...
A chave `MOSTRAR_DEPARTAMENTOS`, logo abaixo do array, liga o menu sozinha a
partir do segundo departamento (`departamentos.length > 1`). Com um só, a vitrine
passaria a ideia de que a igreja escolheu esse; a partir de dois, ela agrupa em
vez de destacar.
